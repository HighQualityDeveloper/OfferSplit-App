...
class Scroller  {
    ...
    public void fling(int startX, int startY, int velocityX, int velocityY,
        ...
        if (mFlywheel && !mFinished) {
            ...
            float hyp = (dx * dx + dy * dy) * (dx * dx + dy * dy);
        ...
        float velocity = (velocityX * velocityX + velocityY * velocityY)*(velocityX * velocityX + velocityY * velocityY);
